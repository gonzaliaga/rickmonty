              ...
              <div data-aos="fade-right" className='characters__container__pagination__character' key={key}>
                ...
                <div className="characters__container__pagination__character__allInfo" style={{ display: "none" }}>
                  <ul>
                    ...
                    <li>
                      Episodio/s: <a target="_blank" rel="noreferrer" href={item.episode[0]}>episodio</a>
                    </li>
                    <li>
                      Género: <span>{item.gender}</span>
                    </li>
                    <li>
                      Procedencia: <span>{item.location.name}</span>
                    </li>
                    <li>
                ...
                <div className="characters__container__pagination__character__addInfo">
                  ...
                  <h3 className="characters__container__pagination__character__addInfo__location">De: <span>{item.location.name}</span></h3>
                  <p className="characters__container__pagination__character__addInfo__species">Especie: <span>{item.species}</span></p>
                  <p className="characters__container__pagination__character__addInfo__status">Estado: <span>{item.status}</span></p>
                  <p className="characters__container__pagination__character__addInfo__gender">Genero: <span>{item.gender}</span></p>
                </div>
              </div>
            )
          })}
