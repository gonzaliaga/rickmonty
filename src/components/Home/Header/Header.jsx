      ...
      <nav className="header__nav container">
        ...
        <ul className="header__nav__list" data-aos="fade-left" style={{top: visibility}}>
          <li className="header__nav__list__item">
            <a href="#characters" className='header__nav__list__item__link'>Personajes</a>
          </li>
          <li className="header__nav__list__item">
            <a href="#episodes" className='header__nav__list__item__link'>Episodios</a>
          </li>
          <li className="header__nav__list__item">
            <a href="#locations" className='header__nav__list__item__link'>Lugares</a>
          </li>
          <li className="header__nav__list__item">
            <a href="#watchList" className='header__nav__list__item__link'>Episodios por ver</a>
          </li>
        </ul>
