  ...
  return (
    <section className="episodes" id="episodes">
      ...
      <div className="episodes__container container">
        {/* Title */}
        <h1 className="episodes__container__title">Episodios</h1>
          ...
          {episodes.map((episode, key) => {
            return (
              <div data-aos="fade-up" className="episodes__container__episodes-wrap__episode" key={key}>
                ...
                <h3 className="episodes__container__episodes-wrap__episode__name">Nombre Episodio: <span>{episode.name}</span></h3>
                <p className="episodes__container__episodes-wrap__episode__airDate">Publicado: <span>{episode.air_date}</span></p>
                <p className="episodes__container__episodes-wrap__episode__url">Mirar <a target="_blank" rel="noreferrer" href={episode.url}>episode</a></p>
              </div>
            )
          })}
        </div>
